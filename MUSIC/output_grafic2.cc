...
protected:
	...
	typedef struct{
		...
		float astart0,omega_m0,omega_b0,omega_l0,h00;
//***************implemented omega_b0 NW********************************8
  ...
  //float metal_floor_;
	...
	void write_file_header( std::ofstream& ofs, unsigned ilevel, const grid_hierarchy& gh )
	{
		...
		double 
			...
			omegab		= cf_.getValue<double>("cosmology","Omega_b"),
//*********************************************implemented omegab*****************************
		...
		loc_head.omega_b0 = omegab;
//***********************added term for omegab*****************************************
